<template>
  <el-container>
    <el-aside class="LeftAside" :class="{LeftAsideDark: IsDarkMode}" width="90px">
      ...
      <el-menu
        class="LeftAsideMenu"
        :class="{LeftAsideMenuDark: IsDarkMode}"
        active-text-color="#4e519e"
      >
        <el-menu-item
          id="chat"
          index="1-1"
...
export default {
  ...
  methods: {
    ...
    GetForbiddenWord() {
      this.axios.post("api/chat/get_forbidden_word").then(response => {
    ...
    UpdateUnread(data) {
      ...
      this.unread_contacts.splice(
        this.unread_contacts.indexOf(data.contact),
        1
      );
    },
...
.el-container {
  ...
  .LeftAside {
    ...
    .LeftAsideMenu {
      ...
      .el-menu-item.is-active {
        background-color: var(--left-clicked-color);
      }
    }
  }
  ...
  .LeftAsideDark {
    ...
    .LeftAsideMenuDark {
      ...
      .MenuItemDark:hover {
        background-color: var(--left-hover-color-dark);
      }

      .MenuItemDark.is-active {
        background-color: var(--left-clicked-color-dark);
      }
    }
  }
}
